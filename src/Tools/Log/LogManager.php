...
namespace NftZxinchainn\Tools\Log;
...
{
    /**
     * @var \NftZxinchainn\Log\ServiceContainer
     */
    protected $app;
     ...
     *
     * @param \NftZxinchainn\Base\ServiceContainer $app
     */
    ...
    {
        return new Monolog('NFT_zxin', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/NFT_zxin/NFT_zxin.log',
